...
public class PlayerBowlingScore {
    /*
        ...
        ALTER TABLE public.player_bowling_score
    ...
    */
    ...
    public static void insert(Connection connection, int playerId, int matchId, int inningsNum,
                              ...
                              int ballsBowled, int numMaidens, int runsGiven, int wicketsTaken, int numNoBalls,
        ...
        preparedStatement.setInt(6, ballsBowled);
