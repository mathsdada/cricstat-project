...
class Series {
    static Database.Model.Series build(Element seriesElement) {
        ...
        return new Database.Model.Series(seriesId, seriesTitle, getSeriesMatchList(Configuration.HOMEPAGE + seriesUrl));
    }

    private static ArrayList<Database.Model.Match> getSeriesMatchList(String seriesUrl) {
        ...
        ArrayList<Database.Model.Match> matches = new ArrayList<>();
        HashMap<String, Database.Model.Player> playerCacheMap = new HashMap<>();
